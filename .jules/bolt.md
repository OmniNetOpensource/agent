...
## 2026-03-05 - ISO-8601 Date String Sorting Optimization
...
**Action:** Always use lexical comparison operators (`<`, `>`, `===`) when sorting or comparing ISO-8601 timestamps instead of `localeCompare` to avoid the overhead of locale-aware string comparison algorithms.
