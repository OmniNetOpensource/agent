...
## 2025-07-25 - [Replace localeCompare with lexical comparison for ISO dates]
...
**Action:** Always prefer basic lexical comparison operators (`<`, `>`) over `localeCompare` when sorting ISO date strings to improve sorting performance, particularly for large arrays of dates.
