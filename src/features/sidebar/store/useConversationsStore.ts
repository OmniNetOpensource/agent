...
const sortByPinnedAt = (conversations: Conversation[]): Conversation[] => {
  ...
  sorted.sort((a, b) => {
    ...
    // Lexical string comparison is significantly faster than localeCompare for ISO-8601 dates
...
const mergeConversations = (
  ...
  // Iterate over map.values() directly to prevent intermediate array allocation
...
>((set, get) => ({
  ...
  updateConversationTitle: async (id, title) => {
    ...
    // Sequential find avoids O(N) allocation of array concatenation
    const target =
