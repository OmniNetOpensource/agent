...
// ⚡ Bolt: Using Iterable avoids an intermediate array allocation when passing map.values() directly
...
const mergeConversations = (
  ...
  // ⚡ Bolt: Iterate over map.values() directly instead of creating an intermediate array
