...
// Optimization: Accept an Iterable instead of an Array to avoid intermediate array allocation
// Expected impact: Eliminates O(N) memory allocation and redundant O(N) iteration when merging large lists.
