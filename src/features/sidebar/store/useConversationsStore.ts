...
// ⚡ Bolt Optimization: Accept Iterable to avoid intermediate array allocation
...
const mergeConversations = (
  ...
  // ⚡ Bolt Optimization: Iterate directly over map.values() to prevent O(N) array allocation
