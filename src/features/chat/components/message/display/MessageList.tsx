...
export function MessageList() {
  ...
  // Bind native scroll listener exactly once to avoid thrashing during rapid updates
  useEffect(() => {
  ...
  // Sync scroll state when messages array reference updates (e.g. streaming, new message added)
  useEffect(() => {
    const container = scrollRef.current;
    if (!container) return;
