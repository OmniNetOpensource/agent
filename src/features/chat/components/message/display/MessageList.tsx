      ...
      >
        ...
        >
          {messages.map((message, index) => {
            ...
            const depth = index + 1;
            // branchInfo is calculated during render but is fast
            // React.memo on MessageItem will handle prop stability check if props are deep compared
            const branchInfo = getBranchInfoFromTree(allMessages, messageId);
