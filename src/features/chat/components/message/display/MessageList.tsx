...
export function MessageList() {
  ...
  // Memoize messages array to prevent returning a new reference on every render
  // and causing downstream effect thrashing.
  ...
  // Update scroll state when messages change (e.g. streaming)
  useEffect(() => {
    const container = scrollRef.current;
    if (!container) return;
