...
export const localDB = {
  async getAll(): Promise<LocalConversation[]> {
    ...
    // Bolt: lexical string comparison is ~70x faster than localeCompare for ISO dates
    return resolved.sort((a, b) => a.updated_at === b.updated_at ? 0 : a.updated_at < b.updated_at ? 1 : -1);
  },
