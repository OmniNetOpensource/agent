...
const components: React.ComponentProps<typeof ReactMarkdown>["components"] = {
  ...
  h4: ({ className, ...props }) => (
    <h4
      {...props}
      className={cx("mt-3 mb-2 text-sm font-medium text-foreground", className)}
    />
  ),
  p: ({ className, ...props }) => (
    <p
      {...props}
      className={cx("mb-3 leading-relaxed text-(--text-secondary)", className)}
    />
  ),
  ul: ({ className, ...props }) => (
    <ul
  ...
  li: ({ className, ...props }) => (
    <li {...props} className={cx("leading-relaxed text-current", className)} />
  ),
  ...
  hr: ({ className, ...props }) => (
    <hr {...props} className={cx("my-4 border-(--border-subtle)", className)} />
  ),
  ...
  em: ({ className, ...props }) => (
    <em {...props} className={cx("text-foreground italic", className)} />
  ),
  a: ({ className, ...props }) => (
    <a
      {...props}
