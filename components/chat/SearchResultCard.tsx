...
export function SearchResultCard({
  ...
  return (
    <a
      ...
      className="group flex w-[260px] flex-shrink-0 flex-col gap-2 rounded-2xl border border-(--border-subtle) bg-(--surface-card) p-4 shadow-soft transition-all duration-300 hover:-translate-y-1 hover:border-(--border-hover) hover:shadow-float focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500/60 dark:hover:border-(--border-strong) animate-fade-in-left"
    ...
    >
      <div className="flex items-start gap-2">
        ...
        <ExternalLink className="h-4 w-4 flex-shrink-0 text-(--text-tertiary) opacity-0 transition-opacity duration-200 group-hover:opacity-100" />
      </div>
